...
require (
	...
	github.com/rhecosystemappeng/patch-utils v0.0.0-20240911214936-e6944e504579
...
replace (
	...
	// last k8s.io vefor Go 1.21 is v0.29.8.
	...
	// last controller-runtime for Go 1.21 is v0.17.6.
